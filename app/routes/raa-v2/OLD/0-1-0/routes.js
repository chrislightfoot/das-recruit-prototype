module.exports = function (router) {
  ...
  var version = '0-1-0'
  var employer_base_url = 'raa-v2/' + version + '/employer'
  ...
  router.get('/' + employer_base_url + '/create-vacancy-options/create-vacancy-choice', function (req, res) {
    res.render('raa-v2/' + version + '/employer/create-vacancy-options/create-vacancy-choice', {
      "data" : req.session,
      }
    )
  })
  router.post('/' + employer_base_url + '/create-vacancy-options/create-vacancy-choice', function (req, res) {
    if(req.body.create_option == "new"){
      res.redirect(301, '/' + employer_base_url + '/create-vacancy-options/title-alt')
    }else{
      res.redirect(301, '/' + employer_base_url + '/create-vacancy-options/clone-vacancy-alt')
    }
  })
  router.post('/' + employer_base_url + '/create-vacancy-options/title-alt', function (req, res) {
    req.session.numberOfPositions = req.body.numberOfPositions || 1
    res.redirect(301, '/' + employer_base_url + '/create-vacancy-options/short-description-alt')
  })
  router.post('/' + employer_base_url + '/create-vacancy-options/clone-vacancy', function (req, res) {
    res.redirect(301, '/' + employer_base_url + '/create-vacancy-options/clone-vacancy-results')
  })
  router.post('/' + employer_base_url + '/create-vacancy-options/display-employer', function (req, res) {
    ...
    if(req.body.selected_display_name== "anonymous"){
      ...
      res.redirect(301, '/' + employer_base_url + '/create-vacancy-options/location-alt')
    }
  })
  router.get('/' + employer_base_url + '/create-vacancy-options/employer-alt', function (req, res) {
    res.render(employer_base_url + '/create-vacancy-options/employer-alt', {
      "data" : req.session,
      "locations" : locations,
      }
    )
  ...
  // EMPLOYER | PREVIEW
  router.get('/' + employer_base_url + '/vacancy-preview', function (req, res) {
    res.render(employer_base_url + '/vacancy-preview', {
      "data" : req.session,
      }
    )
  })
