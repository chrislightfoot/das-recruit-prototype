module.exports = function (router) {
  ...
  require('./new-flow.js')(router);
  require('./disability-confident.js')(router);
require('./dashboard.js')(router);
require('./RVDB-14-search.js')(router);
require('./RVDB-12-dashboard.js')(router);
