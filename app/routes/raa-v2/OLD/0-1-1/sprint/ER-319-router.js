module.exports = function (router) {
  ...
  var version = '0-1-1'
  var employer_base_url = 'raa-v2/' + version + '/sprint/ER-319';
  ...
  // ADDED in 0-1-1 ER-319
  router.post('/' + employer_base_url + '/create-vacancy-options/location-different-address', function (req, res) {
    var url = '/' + employer_base_url + '/create-vacancy-options/training'
    if(req.body.location_option == "different"){
      url = '/' + employer_base_url + '/create-vacancy-options/find-address'
    }
