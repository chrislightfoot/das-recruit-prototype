module.exports = function (router) {
  ...
  // #employer
  router.get('/' + base_url + '/vacancies3-2', function (req, res) {
    console.log("vacancies")
    console.log("vacancies.length : "+vacancies.length)
    console.log("-------")
    console.log(vacancies)
    res.render(base_url + '/vacancies3-2', {
      "data" : req.session,
      "locations" : locations,
      "query" : req.query,
      "providers" : providers,
  ...
  router.get('/' + base_url + '/vacancies3-2-live', function (req, res) {
    res.render(base_url + '/vacancies3-2-live', {
      "data" : req.session,
      "locations" : locations,
      "query" : req.query,
      "providers" : providers,
  ...
  router.get('/' + base_url + '/vacancies3-2-with-applications', function (req, res) {
    res.render(base_url + '/vacancies3-2-with-applications', {
      "data" : req.session,
      "locations" : locations,
      "query" : req.query,
      "providers" : providers,
  ...
  router.get('/' + base_url + '/vacancies3', function (req, res) {
    res.render(base_url + '/vacancies3', {
      "data" : req.session,
      "locations" : locations,
      "query" : req.query,
      "providers" : providers,
  ...
  router.get('/' + base_url + '/vacancies3-3', function (req, res) {
    res.render(base_url + '/vacancies3-3', {
      "data" : req.session,
      "locations" : locations,
      "query" : req.query,
      "providers" : providers,
  ...
  router.get('/' + base_url + '/vacancies5', function (req, res) {
    res.render(base_url + '/vacancies5', {
      "data" : req.session,
      "locations" : locations,
      "query" : req.query,
      "providers" : providers,
  ...
  router.get('/' + base_url + '/vacancies7', function (req, res) {
    console.log()
    res.render(base_url + '/vacancies7', {
      "data" : req.session,
      "locations" : locations,
      "query" : req.query,
      "providers" : providers,
