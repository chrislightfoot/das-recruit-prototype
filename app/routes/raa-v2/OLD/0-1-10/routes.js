module.exports = function (router) {
  ...
  require('./RVDB-46-training.js')(router)
  require('./RVDB-52-wages.js')(router)
  require('./RVDB-110-improved-preview.js')(router)
  require('./RVDB-109-provider-move.js')(router)
  require('./RVDB-50-move-short-description.js')(router)
  require('./RVDB-108-remove-summary.js')(router);
  require('./RVDB-93-skip-provider.js')(router);
  require('./RVDB-55-disabilty-confident')(router);
  require('./RVDB-40-new-journey-employer.js')(router);
  require('./RVDB-40-new-journey-split.js')(router);
  require('./RVDB-40-new-journey-final.js')(router)
