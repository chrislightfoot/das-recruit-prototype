module.exports = function(router) {
  ...
  require('./collaboration.js')(router)
  require('./autocheck.js')(router)
  require('./RVDB-151-profanity-check.js')(router)
  require('./RVDB-147-employer-dashboard.js')(router)
  require('./set-notifications-interupt.js')(router)
